...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapgoCapacitorDataStorageSqlite", path: "../../../node_modules/.bun/@capgo+capacitor-data-storage-sqlite@file+../node_modules/@capgo/capacitor-data-storage-sqlite")
    ],
    targets: [
        .target(
            name: "CapApp-SPM",
